...
export default class Dashboard extends LitElement {
  ...
  constructor() {
    ...
    this.travelAppDestinations = travelAppService.getDestinations();
    this.travelAppImageSet1 = travelAppService.getImageSet1();
    this.travelAppImageSet2 = travelAppService.getImageSet2();
  }
  ...
  @state()
  private travelAppDestinations: DestinationsType[] = [];

  @state()
  private travelAppImageSet1: ImageSet1Type[] = [];

  @state()
  private travelAppImageSet2: ImageSet2Type[] = [];
      ...
      <div class="column-layout left-content">
        ...
        <div class="column-layout bottom-content">
          ...
          <div class="column-layout destinations">
            ...
            <div class="row-layout group_2">
              ${this.travelAppDestinations?.map((item) => html`
                <igc-card class="card">
                  <igc-card-media class="media-content">
                    <img src="${item.image_url}" class="image" />
                  </igc-card-media>
          ...
          <div class="column-layout group_8">
            <div class="row-layout group_9">
              <div class="row-layout group_10">
                ${this.travelAppImageSet1?.map((item) => html`
                  <img src="${item.image_url}" class="image_1" />
                `)}
                ${this.travelAppImageSet2?.map((item) => html`
                  <img src="${item.image_url}" class="image_1" />
                `)}
              </div>
            </div>
